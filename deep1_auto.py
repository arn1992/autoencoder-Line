...
# Encoder Layers
autoencoder.add(Dense(512, input_shape=(input_dim,), activation='relu'))
...
encoder = Model(input_img, encoder_layer7(encoder_layer6(encoder_layer5(encoder_layer4(encoder_layer3(encoder_layer2(encoder_layer1(input_img))))))))
